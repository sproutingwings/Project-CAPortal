                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item dropdown">
                                <p >
                                    <a id="headr" href="#"  class="nav-link dropdown-toggle"><span><i class="fa fa-sign-in">&nbsp;</i>Login |</span></a> 
                                    <a id="headr" href="#"  class="nav-link dropdown-toggle"><span><i class="fa fa-user">&nbsp;</i>Register |</span> </a>
                                    <a id="headr" href="#"  class="nav-link dropdown-toggle"> <span><i class="fa fa-question">&nbsp;</i>Forget password</span> </a>
                                </p> </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="compose-ml">
                        <a class="btn" href="#"><span class="pull-center"><h4>Forget Your password? Get Your Password here...</h4></span></a>
                    </div>
                    <form method="post" action="pass.php">
                        <input class="form-control" type="email" name="email" placeholder="Enter Your Email ID"><br>
                        
                        <button class="btn btn-danger" type="submit" name="submit">Get Password</button>
                    </form>
