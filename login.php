...
#sc{font-size:25px; letter-spacing: 25px; text-align: center; color: #fff; background-color: #7e4a35; }
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="compose-ml">
                        <a class="btn" href="#"><span class="pull-center"><h4>Login Form</h4></span></a>
                    </div>
                    <div class="frm">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    x.value = Math.floor((Math.random() * 100000) + 1);
